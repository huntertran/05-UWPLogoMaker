namespace UniversalLogoMaker.Services.DragAndDrop
{
    ...
    public class DragDropService
    {
        ...
        private static void OnConfigurationPropertyChanged(DependencyObject dependencyObject,
        ...
        private static void ConfigureUIElement(UIElement element, DropConfiguration configuration)
        {
            ...
            element.Drop += async (sender, args) => { await configuration.ProcessComandsAsync(args.DataView); };
        }
        ...
        private static void OnVisualConfigurationPropertyChanged(DependencyObject dependencyObject,
            DependencyPropertyChangedEventArgs e)
        {
            var element = dependencyObject as UIElement;
